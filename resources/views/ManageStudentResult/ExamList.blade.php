                ...
                <div class="max-w-xl">
                    ...
                    <div class="mt-10 grid grid-cols-2 gap-x-6 gap-y-6 sm:grid-cols-6">
                        <div class="sm:col-span-2">
                            ...
                            <div class="mt-2">
                                <select id="year" name="session" autocomplete="year" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6">
                                    <option>3</option>
                                    <option>4</option>
                                    <option>5</option>
                                </select>
                        ...
                        <table class="table-auto w-full">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="px-4 py-2">PEPERIKSAAN AKHIR TAHUN</td>
                                    <td class="px-4 py-2">5 BESTARI</td>
                                    <td class="px-4 py-2">BAHASA ARAB</td>
                                    <td class="px-4 py-2">BELUM DITAFSIR</td>
                                    <td><button type="delete" class="w-6 h-6"> <img src="delete.png" alt="Delete" /></button>
