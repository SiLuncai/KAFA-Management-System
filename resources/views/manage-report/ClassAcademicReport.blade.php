<x-app-layout>
    <div class="container mx-auto py-8">
        <h1 class="text-2xl font-bold mb-4">LAPORAN AKADEMIK KELAS</h1>
    
        <form action="{{ route('class-academic-report') }}" method="POST" id="filterForm">
            @csrf
        ...
        @if (isset($resultsFound) && $resultsFound)
            <div class="mt-8">
                <h2 class="text-xl font-semibold mb-2">LAPORAN AKADEMIK KELAS</h2>
